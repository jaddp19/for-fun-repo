<!-- ========== HEADER ========== -->
<header
    class="bg-red-700 fixed top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-48 lg:z-61 w-full text-sm py-2.5 bg-gray-700">
    <nav class="px-4 sm:px-5.5 flex basis-full items-center w-full mx-auto">
        <div class="w-full flex items-center gap-x-1.5">
            <h2 class="font-semibold text-white">SHOP OWNER</h2>
            <ul class="flex items-center gap-1.5">
                <li
                    class="inline-flex items-center relative text-black pe-1.5 last:pe-0 last:after:hidden after:absolute after:top-1/2 after:end-0 after:inline-block after:w-px after:h-3.5 after:bg-gray-300 after:rounded-full after:-translate-y-1/2 after:rotate-12 dark:text-neutral-200 dark:after:bg-neutral-700">
                    <!-- Sidebar Toggle -->
                    <button type="button"
