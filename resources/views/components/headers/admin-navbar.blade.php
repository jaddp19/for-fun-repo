        ...
        <div class="lg:pt-13 relative flex flex-col h-full max-h-full">
            ...
            <nav
                ...
                <div class="lg:hidden mb-2 flex items-center justify-between">
                    ...
                    <!-- Sidebar Toggle -->
                    <button type="button"
                        class="p-1.5 size-7.5 inline-flex items-center gap-x-1 text-xs rounded-md text-white    isabled:pointer-events-none focus:outline-hidden dark:text-neutral-500"
                ...
                <div 
                    ...
                    <ul class="flex flex-col gap-y-1">
                        <li>
                            <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-neutral-200 rounded-lg hover:bg-red-500 focus:outline-hidden focus:bg-red-500 dark:focus:bg-neutral-800"
                ...
                <div
                    ...
                    <ul class="flex flex-col gap-y-1">
                        <li>
                            <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-neutral-200 rounded-lg dark:focus:bg-neutral-800 hover:bg-red-500 focus:outline-hidden focus:bg-red-500"
                                wire:current="bg-red-500"
                                href="/admin/roles">
                                Roles
                            </a>
