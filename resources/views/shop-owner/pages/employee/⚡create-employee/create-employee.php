...
new #[Layout('layouts.app-shop-owner')] class extends Component
{
    ...
    public string $selectedRole = 'employee';
    ...
    public function create()
    {
        ...
        return redirect()->route('shop-owner.employee.view');
    }
    ...
    {
        return Role::select('id', 'name')->where('name', 'employee')->get();
    }
};